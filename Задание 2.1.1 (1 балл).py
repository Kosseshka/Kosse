...
class DataSet:
    ...
    def get_statistic(self):
        ...
        stats2 = self.medium(salary_of_vacancy_name)
        stats3 = self.medium(salary_city)
    ...
    @staticmethod
    def statistic_print(stats1, stats2, stats3, stats4, stats5, stats6):
...
class InputConnect:
    def __init__(self):
        ...
        dataset.statistic_print(stats1, stats2, stats3, stats4, stats5, stats6)
